...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("initiator", sa.String(255), nullable=False),
        sa.Column("state", sa.String(32), nullable=False),
        sa.Column("revision", sa.Integer(), nullable=False),
        sa.Column("cleanup_context", sa.JSON()),
        sa.Column("final_outcome", sa.String(32)),
        sa.Column("attention_reason", sa.String(256)),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("experiment_id", "sequence"),
    )
    ...
    op.create_index(
        ...
        ["target_id"],
        unique=True,
        sqlite_where=sa.text("state NOT IN ('passed','cancelled','failed','operator_attention')"),
    )
